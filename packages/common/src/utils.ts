...
export function updateSiteManifestStaticLinksInplace(
  ...
  if ((data as any).analytics_plausible_script) {
    data.options.analytics_plausible_script = (data as any).analytics_plausible_script;
    delete (data as any).analytics_plausible_script;
  }
